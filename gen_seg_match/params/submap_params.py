...
class SubmapParams:
    ...
    creation_method: str = 'force_fill'             # Method for creating submaps: ('force_fill', 'distance', 'set_times')
    max_size: int = 40                              # Maximum number of segments in a submap (to save computation)
    # TODO: Do we need use_avg_time_as_segment_ref_time? Could we shorten the param name haha?
    ...
    # the following are applicable only if creation_method == 'distance' -----------
