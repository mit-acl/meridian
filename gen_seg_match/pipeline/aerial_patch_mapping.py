...
Usage:
    python3 -m gen_seg_match.pipeline.aerial_patch_mapping \
...
from gen_seg_match.params.cross_view_params import (
...
from gen_seg_match.pipeline.cross_view_matching import _aerial_viz_worker
