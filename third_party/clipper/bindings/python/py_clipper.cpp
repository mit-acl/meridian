...
void pybind_invariants(py::module& m)
{
  ...
  //
  // General Segment Distance affinity metric
  //
  py::class_<GeneralSegmentDistance, PairwiseAndSingleInvariant, 
      PyPairwiseAndSingleInvariant<GeneralSegmentDistance>, 
      std::shared_ptr<GeneralSegmentDistance>> 
      general_segment_distance(m, "GeneralSegmentDistance");
  general_segment_distance.def(py::init<const GeneralSegmentDistance::Params&>());

  py::enum_<GeneralSegmentDistance::SegmentType>(general_segment_distance, "SegmentType")
    .value("POINT", GeneralSegmentDistance::SegmentType::POINT)
    .value("LINE", GeneralSegmentDistance::SegmentType::LINE)
    .value("PLANE", GeneralSegmentDistance::SegmentType::PLANE)
    .export_values();

  py::class_<GeneralSegmentDistance::Params>(m, "GeneralSegmentDistanceParams")
    .def(py::init<>())
    .def("__repr__", [](const GeneralSegmentDistance::Params &params) {
      std::ostringstream repr;
      repr << "<GeneralSegmentDistanceParams : dim=" << params.dim;
      repr << " ratio_feature_dim=" << params.ratio_feature_dim;
      repr << " cos_feature_dim=" << params.cos_feature_dim;
      repr << " sigma_dist=" << params.sigma_dist;
      repr << " epsilon_dist=" << params.epsilon_dist;
      repr << " min_dist=" << params.min_dist;
      repr << " sigma_angle_rad=" << params.sigma_angle_rad;
      repr << " epsilon_angle_rad=" << params.epsilon_angle_rad;
      repr << " min_angle_rad=" << params.min_angle_rad;
      repr << " distance_weight=" << params.distance_weight;
      repr << " ratio_weight=" << params.ratio_weight;
      repr << " cosine_weight=" << params.cosine_weight;
      repr << " ratio_epsilon=" << params.ratio_epsilon;
      repr << " cosine_min=" << params.cosine_min;
      repr << " cosine_max=" << params.cosine_max;
      repr << " z_dir_constrained=" << params.z_dir_constrained;
      repr << " xyz_dir_constrained=" << params.xyz_dir_constrained;
      repr << " xy_dir_constrained_2d=" << params.xy_dir_constrained_2d;
      repr << " rot_unc_ang_rad=" << params.rot_unc_ang_rad;
      repr << " point_noise_from_angle=" << params.point_noise_from_angle;
      repr << " bidirectional=" << params.bidirectional;
      repr << ">";
      return repr.str();
    })
    .def_readwrite("dim", &clipper::invariants::GeneralSegmentDistance::Params::dim)
    .def_readwrite("ratio_feature_dim", &clipper::invariants::GeneralSegmentDistance::Params::ratio_feature_dim)
    .def_readwrite("cos_feature_dim", &clipper::invariants::GeneralSegmentDistance::Params::cos_feature_dim)
    .def_readwrite("sigma_dist", &clipper::invariants::GeneralSegmentDistance::Params::sigma_dist)
    .def_readwrite("epsilon_dist", &clipper::invariants::GeneralSegmentDistance::Params::epsilon_dist)
    .def_readwrite("min_dist", &clipper::invariants::GeneralSegmentDistance::Params::min_dist)
    .def_readwrite("sigma_angle_rad", &clipper::invariants::GeneralSegmentDistance::Params::sigma_angle_rad)
    .def_readwrite("epsilon_angle_rad", &clipper::invariants::GeneralSegmentDistance::Params::epsilon_angle_rad)
    .def_readwrite("min_angle_rad", &clipper::invariants::GeneralSegmentDistance::Params::min_angle_rad)
    .def_readwrite("distance_weight", &clipper::invariants::GeneralSegmentDistance::Params::distance_weight)
    .def_readwrite("ratio_weight", &clipper::invariants::GeneralSegmentDistance::Params::ratio_weight)
    .def_readwrite("cosine_weight", &clipper::invariants::GeneralSegmentDistance::Params::cosine_weight)
    .def_readwrite("ratio_epsilon", &clipper::invariants::GeneralSegmentDistance::Params::ratio_epsilon)
    .def_readwrite("cosine_min", &clipper::invariants::GeneralSegmentDistance::Params::cosine_min)
    .def_readwrite("cosine_max", &clipper::invariants::GeneralSegmentDistance::Params::cosine_max)
    .def_readwrite("z_dir_constrained", &clipper::invariants::GeneralSegmentDistance::Params::z_dir_constrained)
    .def_readwrite("xyz_dir_constrained", &clipper::invariants::GeneralSegmentDistance::Params::xyz_dir_constrained)
    .def_readwrite("xy_dir_constrained_2d", &clipper::invariants::GeneralSegmentDistance::Params::xy_dir_constrained_2d)
    .def_readwrite("rot_unc_ang_rad", &clipper::invariants::GeneralSegmentDistance::Params::rot_unc_ang_rad)
    .def_readwrite("point_noise_from_angle", &clipper::invariants::GeneralSegmentDistance::Params::point_noise_from_angle)
    .def_readwrite("bidirectional", &clipper::invariants::GeneralSegmentDistance::Params::bidirectional);
  ...
  py::class_<LoopClosureConsistency::Params>(m, "LoopClosureConsistencyParams")
    .def(py::init<>())
    .def_readwrite("rot_sigma_rad", &LoopClosureConsistency::Params::rot_sigma_rad)
    .def_readwrite("rot_eps_rad",   &LoopClosureConsistency::Params::rot_eps_rad)
    .def_readwrite("trans_sigma_m", &LoopClosureConsistency::Params::trans_sigma_m)
    .def_readwrite("trans_eps_m",   &LoopClosureConsistency::Params::trans_eps_m)
    .def_readwrite("added_trans_noise_m_per_m", &LoopClosureConsistency::Params::added_trans_noise_m_per_m)
    .def_readwrite("added_rot_noise_deg_per_m", &LoopClosureConsistency::Params::added_rot_noise_deg_per_m)
    .def_readwrite("single_lc_per_ground_sm",
                   &LoopClosureConsistency::Params::single_lc_per_ground_sm)
    .def_readwrite("single_lc_per_ground_aerial_pair",
                   &LoopClosureConsistency::Params::single_lc_per_ground_aerial_pair)
    .def_readwrite("fuse_lc_score",
                   &LoopClosureConsistency::Params::fuse_lc_score);

  py::class_<LoopClosureConsistency, PairwiseAndSingleInvariant,
      std::shared_ptr<LoopClosureConsistency>>(m, "LoopClosureConsistency")
    .def(py::init<const std::vector<Eigen::MatrixXd>&,
                  const std::vector<Eigen::MatrixXd>&,
                  const std::vector<double>&,
                  const LoopClosureConsistency::Params&>());

  //
  // Pose Consistency
  //

  py::class_<PoseConsistency::Params>(m, "PoseConsistencyParams")
    .def(py::init<>())
    .def_readwrite("dim",           &PoseConsistency::Params::dim)
    .def_readwrite("rot_sigma_rad", &PoseConsistency::Params::rot_sigma_rad)
    .def_readwrite("rot_eps_rad",   &PoseConsistency::Params::rot_eps_rad)
    .def_readwrite("trans_sigma_m", &PoseConsistency::Params::trans_sigma_m)
    .def_readwrite("trans_eps_m",   &PoseConsistency::Params::trans_eps_m);

  py::class_<PoseConsistency, PairwiseAndSingleInvariant,
      std::shared_ptr<PoseConsistency>>(m, "PoseConsistency")
    .def(py::init<const PoseConsistency::Params&>());
}
