...
from meridian.segment.segment_types import SegmentList, DenseSegment
...
from meridian.viz.img_sparse_viz import img_sparse_viz
from meridian.viz.viz_segments import (
    viz_masks_on_img,
    viz_segments,
    render3d_on_img,
)
from meridian.pipeline.data import RGBDPoseEstimationData
